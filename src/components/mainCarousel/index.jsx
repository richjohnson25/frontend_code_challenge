...
export default function MainCarousel(){
    ...
    return (
        ...
        nextControlIcon={<div className="hidden lg:block bg-orange-500 text-white p-3 rounded-full absolute"><FaArrowRight /></div>}
        previousControlIcon={<div className="hidden lg:block bg-orange-500 text-white p-3 rounded-full absolute"><FaArrowLeft /></div>}>
            <Carousel.Slide>
            <div className="bg-red-100" style={{ width: '100%', height: '400px', position: 'relative' }}>
                ...
                alt="priority"
                />
                <div className="bg-gray-900/50 flex flex-col justify-center items-center gap-8 px-20 lg:px-40 absolute inset-0">
                <h1 className="text-orange-500 text-5xl text-center font-bold drop-shadow-lg">Welcome to Japfa Comfeed Indonesia</h1>
            ...
            <div className="bg-red-100" style={{ width: '100%', height: '400px', position: 'relative' }}>
                ...
                />
                <div className="bg-gray-900/50 flex flex-col justify-center items-center gap-8 px-20 lg:px-40 absolute inset-0">
                <h1 className="text-orange-500 text-5xl text-center font-bold drop-shadow-lg">Our Vision and Mission</h1>
            ...
            <div className="bg-red-100" style={{ width: '100%', height: '400px', position: 'relative' }}>
                ...
                />
                <div className="bg-gray-900/50 flex flex-col justify-center items-center gap-8 px-20 lg:px-40 absolute inset-0">
                <h3 className="text-orange-500 text-5xl text-center font-bold drop-shadow-lg">Our Tagline</h3>
